...
namespace test2
{
        public class Employee
        {
            ...
            {
var mrid = CodeHooks.Instance().OnMethodEnter(@"Program.cs", "Employee", this.GetHashCode(), "fea3b7d1-e56e-4b3b-8f0f-b24cc65e0d30" );
...
CodeHooks.Instance().LogLineRun(mrid, 13, CodeHooks.Now(), "");
            ...
            {
var mrid = CodeHooks.Instance().OnMethodEnter(@"Program.cs", "isEmployeeOf", this.GetHashCode(), "fea3b7d1-e56e-4b3b-8f0f-b24cc65e0d30" );
...
CodeHooks.Instance().LogLineRun(mrid, 27, CodeHooks.Now(), "");
            ...
            {
var mrid = CodeHooks.Instance().OnMethodEnter(@"Program.cs", "ToString", this.GetHashCode(), "fea3b7d1-e56e-4b3b-8f0f-b24cc65e0d30" );
...
set{
        ...
        public class DepthFirstAlgorithm
        {
            ...
            {
var mrid = CodeHooks.Instance().OnMethodEnter(@"Program.cs", "BuildEmployeeGraph", this.GetHashCode(), "fea3b7d1-e56e-4b3b-8f0f-b24cc65e0d30" );
...
CodeHooks.Instance().LogLineRun(mrid, 57, CodeHooks.Now(), "");
            ...
            {
var mrid = CodeHooks.Instance().OnMethodEnter(@"Program.cs", "Search", this.GetHashCode(), "fea3b7d1-e56e-4b3b-8f0f-b24cc65e0d30" );
...
CodeHooks.Instance().LogLineRun(mrid, 72, CodeHooks.Now(), "");
            ...
            {
var mrid = CodeHooks.Instance().OnMethodEnter(@"Program.cs", "Traverse", this.GetHashCode(), "fea3b7d1-e56e-4b3b-8f0f-b24cc65e0d30" );
CodeHooks.Instance().LocalVarUpdate(mrid, "root", "", root, CodeHooks.Now());
...
CodeHooks.Instance().LogLineRun(mrid, 81, CodeHooks.Now(), "");
    ...
    class Program
    {
        ...
        {
var mrid = CodeHooks.Instance().OnMethodEnter(@"Program.cs", "Main", -1, "fea3b7d1-e56e-4b3b-8f0f-b24cc65e0d30" );
