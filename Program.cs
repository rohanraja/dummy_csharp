...
namespace test2
{
        public class Employee
        {
            ...
            {
var mrid = CodeHooks.Instance().OnMethodEnter(@"Program.cs", "Employee", this.GetHashCode(), "2d8dd0ff-aea6-4a01-a8c5-ee86f004abc8" );
...
var mrid = CodeHooks.Instance().OnMethodEnter(@"Program.cs", "Employee", this.GetHashCode(), "acfab156-1337-478d-ae67-18751111a95c" );
...
CodeHooks.Instance().LogLineRun(mrid, 20, CodeHooks.Now(), "");
            ...
            {
var mrid = CodeHooks.Instance().OnMethodEnter(@"Program.cs", "isEmployeeOf", this.GetHashCode(), "2d8dd0ff-aea6-4a01-a8c5-ee86f004abc8" );
CodeHooks.Instance().LocalVarUpdate(mrid, "e", "", e, CodeHooks.Now());
CodeHooks.Instance().LogLineRun(mrid, 33, CodeHooks.Now(), "");
var mrid = CodeHooks.Instance().OnMethodEnter(@"Program.cs", "isEmployeeOf", this.GetHashCode(), "acfab156-1337-478d-ae67-18751111a95c" );
CodeHooks.Instance().LocalVarUpdate(mrid, "mrid", "", mrid, CodeHooks.Now());
...
CodeHooks.Instance().LogLineRun(mrid, 39, CodeHooks.Now(), "");
            ...
            {
var mrid = CodeHooks.Instance().OnMethodEnter(@"Program.cs", "ToString", this.GetHashCode(), "2d8dd0ff-aea6-4a01-a8c5-ee86f004abc8" );
CodeHooks.Instance().LogLineRun(mrid, 45, CodeHooks.Now(), "");
var mrid = CodeHooks.Instance().OnMethodEnter(@"Program.cs", "ToString", this.GetHashCode(), "acfab156-1337-478d-ae67-18751111a95c" );
CodeHooks.Instance().LocalVarUpdate(mrid, "mrid", "", mrid, CodeHooks.Now());
...
set{
        ...
        public class DepthFirstAlgorithm
        {
            ...
            {
var mrid = CodeHooks.Instance().OnMethodEnter(@"Program.cs", "BuildEmployeeGraph", this.GetHashCode(), "2d8dd0ff-aea6-4a01-a8c5-ee86f004abc8" );
CodeHooks.Instance().LogLineRun(mrid, 83, CodeHooks.Now(), "");
var mrid = CodeHooks.Instance().OnMethodEnter(@"Program.cs", "BuildEmployeeGraph", this.GetHashCode(), "acfab156-1337-478d-ae67-18751111a95c" );
CodeHooks.Instance().LocalVarUpdate(mrid, "mrid", "", mrid, CodeHooks.Now());
CodeHooks.Instance().LogLineRun(mrid, 84, CodeHooks.Now(), "LogLineRun");
CodeHooks.Instance().LogLineRun(mrid, 41, CodeHooks.Now(), "");
CodeHooks.Instance().LogLineRun(mrid, 85, CodeHooks.Now(), "");
                Employee Eva = new Employee("Eva");
CodeHooks.Instance().LocalVarUpdate(mrid, "Eva", "", Eva, CodeHooks.Now());
CodeHooks.Instance().LogLineRun(mrid, 86, CodeHooks.Now(), "LocalVarUpdate");
CodeHooks.Instance().LocalVarUpdate(mrid, "Eva", "", Eva, CodeHooks.Now());
CodeHooks.Instance().LogLineRun(mrid, 87, CodeHooks.Now(), "LogLineRun");
CodeHooks.Instance().LogLineRun(mrid, 42, CodeHooks.Now(), "");
CodeHooks.Instance().LogLineRun(mrid, 88, CodeHooks.Now(), "");
                Employee Sophia = new Employee("Sophia");
CodeHooks.Instance().LocalVarUpdate(mrid, "Sophia", "", Sophia, CodeHooks.Now());
CodeHooks.Instance().LogLineRun(mrid, 89, CodeHooks.Now(), "LocalVarUpdate");
CodeHooks.Instance().LocalVarUpdate(mrid, "Sophia", "", Sophia, CodeHooks.Now());
CodeHooks.Instance().LogLineRun(mrid, 90, CodeHooks.Now(), "LogLineRun");
CodeHooks.Instance().LogLineRun(mrid, 43, CodeHooks.Now(), "");
CodeHooks.Instance().LogLineRun(mrid, 91, CodeHooks.Now(), "");
                Employee Brian = new Employee("Brian");
CodeHooks.Instance().LocalVarUpdate(mrid, "Brian", "", Brian, CodeHooks.Now());
CodeHooks.Instance().LogLineRun(mrid, 92, CodeHooks.Now(), "LocalVarUpdate");
CodeHooks.Instance().LocalVarUpdate(mrid, "Brian", "", Brian, CodeHooks.Now());
...
CodeHooks.Instance().LogLineRun(mrid, 96, CodeHooks.Now(), "isEmployeeOf");
                Eva.isEmployeeOf(Brian);
CodeHooks.Instance().LogLineRun(mrid, 97, CodeHooks.Now(), "LogLineRun");
CodeHooks.Instance().LogLineRun(mrid, 47, CodeHooks.Now(), "");
CodeHooks.Instance().LogLineRun(mrid, 99, CodeHooks.Now(), "");
 
                Employee Lisa = new Employee("Lisa");
CodeHooks.Instance().LocalVarUpdate(mrid, "Lisa", "", Lisa, CodeHooks.Now());
CodeHooks.Instance().LogLineRun(mrid, 100, CodeHooks.Now(), "LocalVarUpdate");
CodeHooks.Instance().LocalVarUpdate(mrid, "Lisa", "", Lisa, CodeHooks.Now());
CodeHooks.Instance().LogLineRun(mrid, 101, CodeHooks.Now(), "LogLineRun");
CodeHooks.Instance().LogLineRun(mrid, 48, CodeHooks.Now(), "");
CodeHooks.Instance().LogLineRun(mrid, 102, CodeHooks.Now(), "");
                Employee Tina = new Employee("Tina");
CodeHooks.Instance().LocalVarUpdate(mrid, "Tina", "", Tina, CodeHooks.Now());
CodeHooks.Instance().LogLineRun(mrid, 103, CodeHooks.Now(), "LocalVarUpdate");
CodeHooks.Instance().LocalVarUpdate(mrid, "Tina", "", Tina, CodeHooks.Now());
CodeHooks.Instance().LogLineRun(mrid, 104, CodeHooks.Now(), "LogLineRun");
CodeHooks.Instance().LogLineRun(mrid, 49, CodeHooks.Now(), "");
CodeHooks.Instance().LogLineRun(mrid, 105, CodeHooks.Now(), "");
                Employee John = new Employee("John");
CodeHooks.Instance().LocalVarUpdate(mrid, "John", "", John, CodeHooks.Now());
CodeHooks.Instance().LogLineRun(mrid, 106, CodeHooks.Now(), "LocalVarUpdate");
CodeHooks.Instance().LocalVarUpdate(mrid, "John", "", John, CodeHooks.Now());
CodeHooks.Instance().LogLineRun(mrid, 107, CodeHooks.Now(), "LogLineRun");
CodeHooks.Instance().LogLineRun(mrid, 50, CodeHooks.Now(), "");
CodeHooks.Instance().LogLineRun(mrid, 108, CodeHooks.Now(), "");
                Employee Mike = new Employee("Mike");
CodeHooks.Instance().LocalVarUpdate(mrid, "Mike", "", Mike, CodeHooks.Now());
CodeHooks.Instance().LogLineRun(mrid, 109, CodeHooks.Now(), "LocalVarUpdate");
CodeHooks.Instance().LocalVarUpdate(mrid, "Mike", "", Mike, CodeHooks.Now());
...
CodeHooks.Instance().LogLineRun(mrid, 117, CodeHooks.Now(), "isEmployeeOf");
                Brian.isEmployeeOf(Mike);
CodeHooks.Instance().LogLineRun(mrid, 118, CodeHooks.Now(), "LogLineRun");
CodeHooks.Instance().LogLineRun(mrid, 56, CodeHooks.Now(), "");
CodeHooks.Instance().LogLineRun(mrid, 120, CodeHooks.Now(), "");
 
                return Eva;
CodeHooks.Instance().LogLineRun(mrid, 121, CodeHooks.Now(), "LogLineRun");
CodeHooks.Instance().LogLineRun(mrid, 57, CodeHooks.Now(), "");
CodeHooks.Instance().LogLineRun(mrid, 122, CodeHooks.Now(), "");
            }
 
            public Employee Search(Employee root, string nameToSearchFor)
            {
var mrid = CodeHooks.Instance().OnMethodEnter(@"Program.cs", "Search", this.GetHashCode(), "2d8dd0ff-aea6-4a01-a8c5-ee86f004abc8" );
...
CodeHooks.Instance().LogLineRun(mrid, 126, CodeHooks.Now(), "");
var mrid = CodeHooks.Instance().OnMethodEnter(@"Program.cs", "Search", this.GetHashCode(), "acfab156-1337-478d-ae67-18751111a95c" );
CodeHooks.Instance().LocalVarUpdate(mrid, "mrid", "", mrid, CodeHooks.Now());
CodeHooks.Instance().LogLineRun(mrid, 127, CodeHooks.Now(), "LocalVarUpdate");
CodeHooks.Instance().LocalVarUpdate(mrid, "root", "", root, CodeHooks.Now());
CodeHooks.Instance().LogLineRun(mrid, 128, CodeHooks.Now(), "LocalVarUpdate");
CodeHooks.Instance().LocalVarUpdate(mrid, "nameToSearchFor", "", nameToSearchFor, CodeHooks.Now());
...
CodeHooks.Instance().LogLineRun(mrid, 132, CodeHooks.Now(), "");
                    return root;
CodeHooks.Instance().LogLineRun(mrid, 133, CodeHooks.Now(), "LogLineRun");
CodeHooks.Instance().LogLineRun(mrid, 63, CodeHooks.Now(), "");
CodeHooks.Instance().LogLineRun(mrid, 134, CodeHooks.Now(), "");
}CodeHooks.Instance().LogLineRun(mrid, 134, CodeHooks.Now(), "LogLineRun");
CodeHooks.Instance().LogLineRun(mrid, 64, CodeHooks.Now(), "");
CodeHooks.Instance().LogLineRun(mrid, 136, CodeHooks.Now(), "");
 
                Employee personFound = null;
CodeHooks.Instance().LocalVarUpdate(mrid, "personFound", "", personFound, CodeHooks.Now());
CodeHooks.Instance().LogLineRun(mrid, 137, CodeHooks.Now(), "LocalVarUpdate");
CodeHooks.Instance().LocalVarUpdate(mrid, "personFound", "", personFound, CodeHooks.Now());
CodeHooks.Instance().LogLineRun(mrid, 138, CodeHooks.Now(), "LogLineRun");
CodeHooks.Instance().LogLineRun(mrid, 65, CodeHooks.Now(), "");
CodeHooks.Instance().LogLineRun(mrid, 139, CodeHooks.Now(), "");
...
CodeHooks.Instance().LogLineRun(mrid, 143, CodeHooks.Now(), "");
                    personFound = Search(root.Employees[i], nameToSearchFor);
CodeHooks.Instance().LocalVarUpdate(mrid, "personFound", "", personFound, CodeHooks.Now());
CodeHooks.Instance().LogLineRun(mrid, 144, CodeHooks.Now(), "LocalVarUpdate");
CodeHooks.Instance().LocalVarUpdate(mrid, "personFound", "", personFound, CodeHooks.Now());
...
CodeHooks.Instance().LogLineRun(mrid, 150, CodeHooks.Now(), "");
...
CodeHooks.Instance().LogLineRun(mrid, 155, CodeHooks.Now(), "");
            }
 
            public void Traverse(Employee root)
            {
var mrid = CodeHooks.Instance().OnMethodEnter(@"Program.cs", "Traverse", this.GetHashCode(), "2d8dd0ff-aea6-4a01-a8c5-ee86f004abc8" );
CodeHooks.Instance().LocalVarUpdate(mrid, "root", "", root, CodeHooks.Now());
CodeHooks.Instance().LogLineRun(mrid, 159, CodeHooks.Now(), "");
var mrid = CodeHooks.Instance().OnMethodEnter(@"Program.cs", "Traverse", this.GetHashCode(), "acfab156-1337-478d-ae67-18751111a95c" );
CodeHooks.Instance().LocalVarUpdate(mrid, "mrid", "", mrid, CodeHooks.Now());
...
CodeHooks.Instance().LogLineRun(mrid, 162, CodeHooks.Now(), "WriteLine");
                Console.WriteLine(root.name);
CodeHooks.Instance().LogLineRun(mrid, 163, CodeHooks.Now(), "LogLineRun");
CodeHooks.Instance().LogLineRun(mrid, 77, CodeHooks.Now(), "");
CodeHooks.Instance().LogLineRun(mrid, 164, CodeHooks.Now(), "");
                for (int i = 0; i < root.Employees.Count; i++)
                {
CodeHooks.Instance().LocalVarUpdate(mrid, "i", "", i, CodeHooks.Now());
CodeHooks.Instance().LogLineRun(mrid, 166, CodeHooks.Now(), "LocalVarUpdate");
CodeHooks.Instance().LocalVarUpdate(mrid, "i", "", i, CodeHooks.Now());
...
CodeHooks.Instance().LogLineRun(mrid, 172, CodeHooks.Now(), "");
            }
                public int CodeVine_ClrInstanceId{
                    get{
                        return this.GetHashCode();
    ...
    class Program
    {
        ...
        {
var mrid = CodeHooks.Instance().OnMethodEnter(@"Program.cs", "Main", -1, "2d8dd0ff-aea6-4a01-a8c5-ee86f004abc8" );
CodeHooks.Instance().LocalVarUpdate(mrid, "args", "", args, CodeHooks.Now());
CodeHooks.Instance().LogLineRun(mrid, 185, CodeHooks.Now(), "");
var mrid = CodeHooks.Instance().OnMethodEnter(@"Program.cs", "Main", -1, "acfab156-1337-478d-ae67-18751111a95c" );
CodeHooks.Instance().LocalVarUpdate(mrid, "mrid", "", mrid, CodeHooks.Now());
CodeHooks.Instance().LogLineRun(mrid, 186, CodeHooks.Now(), "LocalVarUpdate");
CodeHooks.Instance().LocalVarUpdate(mrid, "args", "", args, CodeHooks.Now());
CodeHooks.Instance().LogLineRun(mrid, 187, CodeHooks.Now(), "LogLineRun");
CodeHooks.Instance().LogLineRun(mrid, 89, CodeHooks.Now(), "");
CodeHooks.Instance().LogLineRun(mrid, 188, CodeHooks.Now(), "");
            DepthFirstAlgorithm b = new DepthFirstAlgorithm();
CodeHooks.Instance().LocalVarUpdate(mrid, "b", "", b, CodeHooks.Now());
CodeHooks.Instance().LogLineRun(mrid, 189, CodeHooks.Now(), "LocalVarUpdate");
CodeHooks.Instance().LocalVarUpdate(mrid, "b", "", b, CodeHooks.Now());
CodeHooks.Instance().LogLineRun(mrid, 190, CodeHooks.Now(), "LogLineRun");
CodeHooks.Instance().LogLineRun(mrid, 90, CodeHooks.Now(), "");
CodeHooks.Instance().LogLineRun(mrid, 191, CodeHooks.Now(), "");
...
CodeHooks.Instance().LogLineRun(mrid, 194, CodeHooks.Now(), "WriteLine");
...
CodeHooks.Instance().LogLineRun(mrid, 196, CodeHooks.Now(), "Traverse");
            b.Traverse(root);
CodeHooks.Instance().LogLineRun(mrid, 197, CodeHooks.Now(), "LogLineRun");
CodeHooks.Instance().LogLineRun(mrid, 94, CodeHooks.Now(), "WriteLine");
CodeHooks.Instance().LogLineRun(mrid, 199, CodeHooks.Now(), "WriteLine");
 
            Console.WriteLine("\nSearch in Graph\n------");
CodeHooks.Instance().LogLineRun(mrid, 200, CodeHooks.Now(), "LogLineRun");
CodeHooks.Instance().LogLineRun(mrid, 95, CodeHooks.Now(), "");
CodeHooks.Instance().LogLineRun(mrid, 201, CodeHooks.Now(), "");
            Employee e = b.Search(root, "Eva");
CodeHooks.Instance().LocalVarUpdate(mrid, "e", "", e, CodeHooks.Now());
CodeHooks.Instance().LogLineRun(mrid, 202, CodeHooks.Now(), "LocalVarUpdate");
CodeHooks.Instance().LocalVarUpdate(mrid, "e", "", e, CodeHooks.Now());
...
CodeHooks.Instance().LogLineRun(mrid, 204, CodeHooks.Now(), "WriteLine");
...
CodeHooks.Instance().LogLineRun(mrid, 206, CodeHooks.Now(), "");
            e = b.Search(root, "Brian");
CodeHooks.Instance().LocalVarUpdate(mrid, "e", "", e, CodeHooks.Now());
CodeHooks.Instance().LogLineRun(mrid, 207, CodeHooks.Now(), "LocalVarUpdate");
CodeHooks.Instance().LocalVarUpdate(mrid, "e", "", e, CodeHooks.Now());
...
CodeHooks.Instance().LogLineRun(mrid, 209, CodeHooks.Now(), "WriteLine");
            Console.WriteLine(e == null ? "Employee not found" : e.name);
CodeHooks.Instance().LogLineRun(mrid, 210, CodeHooks.Now(), "LogLineRun");
CodeHooks.Instance().LogLineRun(mrid, 99, CodeHooks.Now(), "");
CodeHooks.Instance().LogLineRun(mrid, 211, CodeHooks.Now(), "");
            e = b.Search(root, "Soni");
CodeHooks.Instance().LocalVarUpdate(mrid, "e", "", e, CodeHooks.Now());
CodeHooks.Instance().LogLineRun(mrid, 212, CodeHooks.Now(), "LocalVarUpdate");
CodeHooks.Instance().LocalVarUpdate(mrid, "e", "", e, CodeHooks.Now());
...
CodeHooks.Instance().LogLineRun(mrid, 214, CodeHooks.Now(), "WriteLine");
            Console.WriteLine(e == null ? "Employee not found" : e.name);
CodeHooks.Instance().LogLineRun(mrid, 215, CodeHooks.Now(), "LogLineRun");
CodeHooks.Instance().LogLineRun(mrid, 101, CodeHooks.Now(), "");
CodeHooks.Instance().LogLineRun(mrid, 216, CodeHooks.Now(), "");
        }
                public int CodeVine_ClrInstanceId{
                    get{
                        return this.GetHashCode();
