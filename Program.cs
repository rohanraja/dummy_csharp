...
namespace test2
{
        public class Employee
        {
            ...
            {
var mrid = CodeHooks.Instance().OnMethodEnter(@"Program.cs", "Employee", this.GetHashCode(), "3ea068ea-4caa-480b-a617-2c4bdcd0d130" );
...
CodeHooks.Instance().LogLineRun(mrid, 13, CodeHooks.Now(), "");
            ...
            {
var mrid = CodeHooks.Instance().OnMethodEnter(@"Program.cs", "isEmployeeOf", this.GetHashCode(), "3ea068ea-4caa-480b-a617-2c4bdcd0d130" );
...
CodeHooks.Instance().LogLineRun(mrid, 27, CodeHooks.Now(), "");
            ...
            {
var mrid = CodeHooks.Instance().OnMethodEnter(@"Program.cs", "ToString", this.GetHashCode(), "3ea068ea-4caa-480b-a617-2c4bdcd0d130" );
...
set{
        ...
        public class DepthFirstAlgorithm
        {
            ...
            {
var mrid = CodeHooks.Instance().OnMethodEnter(@"Program.cs", "BuildEmployeeGraph", this.GetHashCode(), "3ea068ea-4caa-480b-a617-2c4bdcd0d130" );
...
CodeHooks.Instance().LogLineRun(mrid, 57, CodeHooks.Now(), "");
            ...
            {
var mrid = CodeHooks.Instance().OnMethodEnter(@"Program.cs", "Search", this.GetHashCode(), "3ea068ea-4caa-480b-a617-2c4bdcd0d130" );
...
CodeHooks.Instance().LogLineRun(mrid, 72, CodeHooks.Now(), "");
            ...
            {
var mrid = CodeHooks.Instance().OnMethodEnter(@"Program.cs", "Traverse", this.GetHashCode(), "3ea068ea-4caa-480b-a617-2c4bdcd0d130" );
CodeHooks.Instance().LocalVarUpdate(mrid, "root", "", root, CodeHooks.Now());
...
CodeHooks.Instance().LogLineRun(mrid, 81, CodeHooks.Now(), "");
    ...
    class Program
    {
        ...
        {
var mrid = CodeHooks.Instance().OnMethodEnter(@"Program.cs", "Main", -1, "3ea068ea-4caa-480b-a617-2c4bdcd0d130" );
